...
export function DashboardSection() {
  ...
  return (
    <section className="h-full py-6 lg:border-l lg:pl-8">
      ...
      <Tabs defaultValue="a-definir-1" className="h-full space-y-6">
        <TabsList>
          <TabsTrigger value="a-definir-1">a-definir-1</TabsTrigger>
          <TabsTrigger value="a-definir-2">a-definir-2</TabsTrigger>
        </TabsList>
        <TabsContent value="a-definir-1">
        </TabsContent>
        <TabsContent value="a-definir-2">
        </TabsContent>
      </Tabs>
    </section>
  );
